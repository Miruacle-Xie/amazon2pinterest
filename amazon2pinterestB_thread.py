...
def loginPinterest(driver, account, password):
    ...
    possible_xpaths = ['//*[@id="HeaderContent"]/div/div/div/div/div[2]/div/div/div/div[10]/button/div/div',
                       '//*[@id="HeaderContent"]/div/div/div[2]/div/div/div/div[5]/div[5]/button/div/div',
...
def amazon2pinterest(driver, category, ASIN):
    ...
    try:
        ...
        possible_xpaths = [
            '/html/body/div[3]/div/div/div/div[2]/div/div[2]/div/div/div[1]/div/div[1]/div/div[1]/a/div/div/div/div/div[1]/img',
